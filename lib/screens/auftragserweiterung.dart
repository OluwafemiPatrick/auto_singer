...
class Auftragserweiterung extends StatefulWidget {
  const Auftragserweiterung({Key? key}) : super(key: key);

  @override
  _AuftragserweiterungState createState() => _AuftragserweiterungState();
}

class _AuftragserweiterungState extends State<Auftragserweiterung> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Auftragserweiterung Intern',
            ...
            Container(
              ...
              child: GestureDetector(
                child: Row(
                  ...
                  children: [
                    Icon(Icons.cloud_upload, color: kWhite,),
                    Text('Scan Barcode',
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text('Dateien wahlen', style: TextStyle(fontSize: 15.0),),
            ),
            Text('Choose a file', style: TextStyle(fontSize: 14.0, fontWeight: FontWeight.w200),)
          ],
        ),
        onTap: () {
